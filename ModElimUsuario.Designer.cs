...
namespace Active
{
	partial class ModElimUsuario
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Modificar o Eliminar Usuario";
			// 
			// groupBox1
			// 
			...
			this.label2.Text = "¿Cuál es el nombre del usuario que desea modificar o eliminar?";
			...
			// label7
			// 
			this.label7.Location = new System.Drawing.Point(257, 138);
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(338, 135);
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(560, 211);
			...
			this.Name = "ModElimUsuario";
			this.Text = "ModElimUsuario";
